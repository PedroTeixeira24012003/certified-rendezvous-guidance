"""
th_mpc_expert_behind_3.py
Closed-loop Tschauner-Hempel NMPC expert for a V-bar proximity approach to a
target on an elliptical orbit, with gentleness shaped into the cost weights
and the velocity-cap penalty kept as a backstop. Solves the OCP at every
control instant, applies the first command, propagates one step, repeats.
"""
...
# cost weights, gentleness shaped into the cost
...
# ============================================================================
def plot_run(res, fname='th_expert_costshaped_behind_3.png'):
