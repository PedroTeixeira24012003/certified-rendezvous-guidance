"""
th_mpc_expert_behind_2.py
Closed-loop Tschauner-Hempel NMPC expert for a V-bar proximity approach to a
target on an elliptical orbit, with the velocity cap penalised in the soft
constraints. Solves the OCP at every control instant, applies the first
command, propagates one step, repeats.
"""
...
# soft-constraint penalties, keep-out firm, velocity cap penalised
...
# ============================================================================
def plot_run(res, fname='th_expert_penalised_behind_2.png'):
