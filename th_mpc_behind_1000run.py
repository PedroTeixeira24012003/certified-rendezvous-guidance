"""
th_mpc_behind_1000run.py
Validation campaign for the cost-shaped Tschauner-Hempel NMPC expert, 1000
closed-loop flights from randomized initial conditions and orbits, each flown
for the full simulation window, with aggregated figures of merit.
"""
...
# Configuration
# ============================================================================
MODE = 'randomized'      # 1000 flight validation study
...
# cost weights, the validated cost-shaped configuration
Q_POS, Q_VEL, R_CTRL = 2.0, 1000.0, 135000.0
QN_SCALE = 50.0

# soft-constraint penalties, keep-out firm, cap penalty kept as backstop
KOZ_ZL, KOZ_ZU = 1e4, 1e4
KOZ_ZL2, KOZ_ZU2 = 1e3, 1e3
VCAP_ZL, VCAP_ZU = 5e2, 5e2
VCAP_ZL2, VCAP_ZU2 = 5e2, 5e2
...
# ============================================================================
def plot_run(res, fname='th_expert_costshaped_behind.png'):
...
# ============================================================================
# Validation campaign over sampled initial conditions and orbits.
# Every flight runs the full window, no early stop at arrival.
# ============================================================================
